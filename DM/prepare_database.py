...
def prepare_db(config, name):
    ...
    if name == "adult":
        ...
        return prepare_bank_marketing(random_seed=seed, device=device)
        ...
        return prepare_covertype(seed, device)
    
    elif name == "airlines":
        return prepare_airlines_optimized(seed, device)

    elif name == "higgs":
        return prepare_higgs(seed, device)
